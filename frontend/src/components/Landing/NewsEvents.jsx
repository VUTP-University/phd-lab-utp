      ...
      {selectedNews && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <div className="primary_object rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                {/* Close Button */}
                <button
                  onClick={closeModal}
                  className="float-right text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
                >
                ...
                {/* Title */}
                <h2 className="primary_text text-2xl font-bold mb-4">
                  {selectedNews.title}
                </h2>
                ...
                {selectedNews.images.length > 0 && (
                  <div className="relative mb-6 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden">
                    <img
                      src={`https://drive.google.com/thumbnail?id=${selectedNews.images[currentImageIndex].drive_file_id}&sz=w1000`}
                      alt={selectedNews.title}
                      className="w-full max-h-[500px] object-contain"
                      onError={(e) => {
                        e.target.src =
                          selectedNews.images[currentImageIndex].drive_web_link;
                      }}
                    />
                ...
                {/* Description */}
                <p className="normal_text text-gray-700 dark:text-gray-300 mb-6 whitespace-pre-wrap">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-sm normal_text">Share:</span>
